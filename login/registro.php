        ...
        <div class="card">
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-md btn-block" style="background-color: #d35400; border-color: #d35400;">Registrarse</button>
                    </div>
                </form>
                <div class="text-center mt-3">
                    <p>¿Ya tienes una cuenta? <a href="login.php" class="text-decoration-none fw-bold" style="color: #d35400;">Inicia sesión</a></p>
                </div>
            </div>
        </div>
    </div>
